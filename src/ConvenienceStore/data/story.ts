...
export const STORY: Record<string, StoryBeat> = {
  ...
  g_A5: {
    ...
    choices: [
      ...
      { labelZh: '"……我也是，有话没说完就出来了。"', labelEn: '"...Me too. I left before things were settled."', next: 'g_fail_alg_1' },
    ],
  },
  g_encourage: {
    id: 'g_encourage',
  ...
  c_A4: {
    ...
    choices: [
      ...
      { labelZh: '"我去帮你把老板叫出来。"', labelEn: '"I\'ll go get the owner for you."', next: 'c_fail_jenny_1' },
    ],
  },
  ...
  h_choice1: {
    ...
    choices: [
      ...
      { labelZh: '"……你好像从来没问过我是谁。"', labelEn: '"...You\'ve never once asked who I am."', next: 'h_fail_direct_1' },
    ],
  },
  ...
  gh_choice: {
    ...
    choices: [
      ...
      { labelZh: '"……反正这里也快拆了。"', labelEn: '"...This place is getting torn down soon anyway."', next: 'gh_fail_1' },
    ],
  },
  gh_kind: {
    id: 'gh_kind',
  ...
  slot1_chen_bo_A1: {
    ...
    next: 'slot1_chen_bo_A1b',
  },
  slot1_chen_bo_A1b: {
    id: 'slot1_chen_bo_A1b',
    character: 'chen_bo',
    position: 'right',
    emotion: 'normal',
    speaker: '陈伯',
    textZh: '你也是本地人？',
    textEn: 'Are you from around here too?',
    choices: [
      { labelZh: '"不是，刚来的。"', labelEn: '"No, just arrived."', next: 'slot1_chen_bo_A2' },
      { labelZh: '"……我也不知道自己能在这里待多久。"', labelEn: '"...I don\'t know how long I\'ll be here either."', next: 'slot1_chen_bo_A1_fail' },
    ],
  },
  slot1_chen_bo_A1_fail: {
    id: 'slot1_chen_bo_A1_fail',
    character: 'chen_bo',
    position: 'right',
    emotion: 'curious',
    speaker: '陈伯',
    textZh: '（他停了一下，侧头打量你。）……你这孩子，从哪儿来的啊？家里人呢？',
    textEn: '(He pauses, tilts his head, looking at you carefully.) ...Where are you from, child? And your family?',
    next: 'fail_jmf_1',
  },
  slot1_chen_bo_A2: {
    id: 'slot1_chen_bo_A2',
  ...
  slot2_drunk_choice: {
    ...
    choices: [
      ...
      { labelZh: '"家里有人担心你吗"', labelEn: '"Is anyone at home worried about you?"', next: 'slot2_drunk_C' },
    ],
  },
  slot2_drunk_A1: {
    id: 'slot2_drunk_A1',
  ...
  slot2_drunk_C: {
    ...
    emotion: 'surprised',
    speaker: '酒鬼',
    textZh: '担心我？（他眨了眨眼，醒了一点。）哟……你才应该担心你自己吧。这么晚，你家大人知道你在这里？',
    textEn: 'Worried about me? (He blinks, sobering slightly.) You\'re one to talk. It\'s this late — does anyone at home know you\'re here?',
    next: 'slot2_drunk_C2',
  },
  slot2_drunk_C2: {
    id: 'slot2_drunk_C2',
    ...
    emotion: 'curious',
    speaker: '酒鬼',
    textZh: '（他歪着脑袋，眼神比刚才清醒了不少。）你……多大了啊。',
    textEn: '(He tilts his head, eyes clearer now than a minute ago.) How old... are you, anyway.',
    next: 'fail_jmf_1',
  },
  ...
  slot3_mei_popo_choice: {
    ...
    choices: [
      ...
      { labelZh: '"要是真的拆了，婆婆你去哪里？"', labelEn: '"If it really gets torn down, where will you go?"', next: 'slot3_mei_popo_C' },
    ],
  },
  slot3_mei_popo_A1: {
  ...
  slot3_mei_popo_C: {
    ...
    emotion: 'happy',
    speaker: '梅婆婆',
    textZh: '我啊——去我儿子那里咯，他在外地。（她笑了笑，然后歪头看你。）你呢？',
    textEn: 'Me? I\'ll go stay with my son. He\'s out of the city. (She smiles, then tilts her head.) And you?',
  ...
  slot3_mei_popo_C2: {
    ...
    emotion: 'curious',
    speaker: '梅婆婆',
    textZh: '……你家在哪里啊。（她的声音轻轻的，不是随口一问。）',
    textEn: '...Where is your home, child? (Her voice is quiet — not a casual question.)',
    next: 'fail_jmf_1',
  },
  ...
  // ═══════════════════════════════════════════════════════════
  //  主线人物失败路径
  //  g_fail_alg_*   : Algram 发现主角在逃家 → 叫出 JM·F
  //  c_fail_jenny_* : Jenny 采访引出疑问 → 叫出 JM·F
  //  h_fail_direct_*: JM·F 直接追问身份
  // ═══════════════════════════════════════════════════════════
  ...
  g_fail_alg_3: {
    ...
    emotion: 'normal',
    speaker: null,
    textZh: '他没再多问。戴上头盔，停了一下，走向后室的门，轻轻敲了两下。"老板，出来一下。"',
    textEn: 'He doesn\'t push further. Puts on his helmet, pauses, then knocks on the stockroom door. "Hey — owner. Come out a second."',
    next: 'g_fail_alg_4',
  },
  g_fail_alg_4: {
    id: 'g_fail_alg_4',
    ...
    emotion: 'surprised',
    speaker: null,
    textZh: 'JM·F推门出来，看了看Algram，又看了看你。Algram没说什么，只是朝你的方向点了点头，然后走进了雨里。',
    textEn: 'JM·F steps out, looks at Algram, then at you. Algram says nothing — just nods in your direction, then walks into the rain.',
    next: 'fail_jmf_4',
  },
  ...
  gh_fail_1: {
    ...
    emotion: 'sad',
    speaker: 'ghostpixel',
    textZh: '……（他静了很久。那层轻薄的透明，开始变暗，变重。）',
    textEn: '...(He goes still for a long time. That thin translucence begins to darken.)',
    next: 'gh_fail_2',
  },
  gh_fail_2: {
    id: 'gh_fail_2',
    ...
    emotion: 'surprised',
    speaker: 'ghostpixel',
    textZh: '……快拆了。（他的声音变了，低而四方。）你也这么说。所有人，都这么说。',
    textEn: '...Getting torn down. (His voice changes — flat, heavy, filling the room.) You too. Everyone. They all say that.',
    next: 'gh_fail_3',
  },
  gh_fail_3: {
    id: 'gh_fail_3',
    speaker: null,
    textZh: '灯闪了几下。货架上有什么东西掉落。然后是极冷的风，从没有方向的地方来——然后是黑暗。',
    textEn: 'The lights flicker. Something falls from the shelves. Then a cold wind with no direction — then darkness.',
    next: 'gh_fail_4',
  },
  gh_fail_4: {
    id: 'gh_fail_4',
    ...
    emotion: 'surprised',
    speaker: null,
    textZh: 'JM·F冲出来，发现你倒在地上，脸色苍白。幽灵已经不在了，连那颗薄荷糖也没有留下。',
    textEn: 'JM·F rushes out. You\'re on the floor, pale. The ghost is gone — not even a mint candy left behind.',
    next: 'fail_robber_5',
  },
  ...
  c_fail_jenny_1: {
    ...
    emotion: 'normal',
    speaker: 'Jenny',
    textZh: '（她看了你一眼，然后拿出采访本。）那正好，你是店里的人——我可以顺便问你几个问题吗？',
    textEn: '(She looks at you, then opens her notebook.) Perfect — you work here. Can I ask you a few questions too?',
    next: 'c_fail_jenny_2',
  },
  c_fail_jenny_2: {
    id: 'c_fail_jenny_2',
    ...
    emotion: 'normal',
    speaker: 'Jenny',
    textZh: '你在这里做多久了？之前做过什么？（她的笔悬在纸上，等着。）',
    textEn: 'How long have you been here? What did you do before? (She holds her pen, waiting.)',
    next: 'c_fail_jenny_3',
  },
  c_fail_jenny_3: {
    id: 'c_fail_jenny_3',
    ...
    emotion: 'curious',
    speaker: null,
    textZh: '你回答了，她记着，偶尔抬头看你。她做过很多访谈，知道什么时候有地方不对。（她合上本子。）',
    textEn: 'You answer. She writes, glancing up occasionally. She\'s done enough interviews to know when something doesn\'t add up. (She closes the notebook.)',
    next: 'c_fail_jenny_4',
  },
  c_fail_jenny_4: {
    id: 'c_fail_jenny_4',
    ...
    emotion: 'sad',
    speaker: 'Jenny',
    textZh: '……我去把老板叫出来。你等一下。',
    textEn: '...Let me go get the owner. Wait here.',
    next: 'fail_jmf_1',
  },
  ...
  h_fail_direct_1: {
    ...
    emotion: 'normal',
    speaker: 'JM·F',
    textZh: '……嗯。（他把账本放下，慢慢看了你一眼。）没有。',
    textEn: '...Hm. (He sets down the ledger, looks at you slowly.) No, I haven\'t.',
    next: 'h_fail_direct_2',
  },
  h_fail_direct_2: {
    id: 'h_fail_direct_2',
    character: 'hacker',
    ...
    speaker: 'JM·F',
    textZh: '那我现在问。——你叫什么名字。',
    textEn: 'Then I\'m asking now. — What\'s your name.',
    next: 'h_fail_direct_3',
  },
  h_fail_direct_3: {
    id: 'h_fail_direct_3',
    character: 'hacker',
