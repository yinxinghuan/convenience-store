...
export const STORY: Record<string, StoryBeat> = {
  ...
  gh_appear: {
    ...
    emotion: 'normal',
    speaker: null,
    textZh: '收银台旁边，光线里有什么东西聚集起来。一个少年的轮廓，半透明的，旧式的衣服，发丝在没有风的地方轻轻飘着。',
  ...
  gh_A1: {
    ...
    emotion: 'surprised',
    speaker: 'ghostpixel',
    textZh: '真的可以。（他愣了一秒，像是不敢相信。）好久了，好久没有人能看见我了。',
    textEn: 'You really can. (He pauses, like he can\'t believe it.) It\'s been so long. So long since anyone could see me.',
    next: 'gh_A2',
    flag: 'ghost_seen',
  },
  gh_A2: {
  ...
  gh_daughter_link: {
    ...
    speaker: 'ghostpixel',
    textZh: '而那个女生……就是他的女儿，对吗。（他轻声说，不像是在问，更像是终于把一件事说出口。）我看着他们今晚，想着如果兰姐还在，她一定会把他们推到一起。',
  ...
  gh_kind: {
    ...
    emotion: 'happy',
    speaker: 'ghostpixel',
    textZh: '……是。很久了。（他笑了，是那种轻的、透明的笑。）谢谢你。',
    textEn: '...Yes. A long time. (He smiles — light, transparent.) Thank you.',
    next: 'gh_final',
    flag: 'ghost_told',
  },
  gh_honest: {
  ...
  gh_leave2: {
    ...
    emotion: 'happy',
    speaker: 'ghostpixel',
    textZh: '但你说可以的话……我想试试。（他往门口飘了一步。）这里的灯，会一直亮着吗？',
    textEn: 'But if you say it\'s okay... I\'ll try. (He drifts a step toward the door.) Will the lights stay on here?',
    next: 'gh_leave3',
    flag: 'ghost_told',
  },
  gh_leave3: {
    ...
    emotion: 'happy',
    speaker: null,
    textZh: '你说：会的。他点了点头，走向玻璃门，透过去了，消失在雨后的街道上。柜台上不知什么时候多了一颗薄荷糖，旧式包装，繁体字。',
    textEn: 'You say: yes. He nods, walks toward the glass door, passes through it, disappears into the wet street. Somehow there\'s a mint candy on the counter — old wrapper, traditional characters.',
    next: 'ending_dawn',
  },
  gh_final: {
    id: 'gh_final',
    ...
    emotion: 'happy',
    speaker: 'ghostpixel',
    textZh: '今晚来了好多人。每个人都带着自己的事，但好像也是来这里的。（他往门边飘了飘。）你是个好店员。',
    textEn: 'So many people tonight. Everyone carrying their own thing — but it feels like they all came here for a reason. (He drifts toward the door.) You\'re a good clerk.',
    next: 'ending_dawn',
  },
  ...
  gh_B2: {
    id: 'gh_B2',
    speaker: null,
    textZh: '他在货架间飘了一会儿，在糖果区站了很久，然后安静地消散了，就好像从未来过。',
    textEn: 'He drifts through the aisles, lingers at the candy section, then quietly dissolves — as if he was never there.',
    next: 'ending_dawn',
  },
  ...
  //
  //  Flags set at restart() pick one per slot.
  //  Each chain: condition → scene beats → next chapter intro
  //  resolveNext() auto-skips unselected options.
  // ═══════════════════════════════════════════════════════════
  ...
  slot1_chen_bo_1: {
    ...
    position: 'right',
    emotion: 'normal',
    condition: 'cust_chen_bo',
    speaker: null,
    textZh: '一个老人推门进来，步子很慢，手里提着个旧布袋子。',
    textEn: 'An old man pushes the door open, stepping slowly, carrying a worn cloth bag.',
    next: 'slot1_chen_bo_2',
  },
  slot1_chen_bo_2: {
    id: 'slot1_chen_bo_2',
    character: 'chen_bo',
    ...
    condition: 'cust_chen_bo',
    speaker: '陈伯',
    textZh: '那个……有小瓶的黄酒吗？就是低度数那种，不要太烈的。',
    textEn: 'Do you have… that small rice wine? The mild kind. Not too strong.',
    next: 'slot1_chen_bo_choice',
  },
  slot1_chen_bo_choice: {
    id: 'slot1_chen_bo_choice',
    character: 'chen_bo',
    position: 'right',
    emotion: 'normal',
    condition: 'cust_chen_bo',
    ...
    textZh: '',
    textEn: '',
    next: 'slot1_xiao_li_1',
    choices: [
      { labelZh: '聊两句', labelEn: 'Chat a bit', next: 'slot1_chen_bo_A1', flag: 'helped_chen_bo' },
      { labelZh: '帮他找酒', labelEn: 'Find the bottle', next: 'slot1_chen_bo_B' },
      { labelZh: '（催他快点）', labelEn: '(Hurry him along)', next: 'slot1_chen_bo_C' },
    ],
  },
  slot1_chen_bo_A1: {
    id: 'slot1_chen_bo_A1',
    ...
    emotion: 'happy',
    speaker: '陈伯',
    textZh: '我在这条街住了三十七年了，三十七年啊。（他笑了一下，眼神有点发远。）说是要拆……我以为他们说说而已的。',
    textEn: 'I\'ve lived on this street thirty-seven years. Thirty-seven. (He smiles, eyes going distant.) They said tear it down… I thought it was just talk.',
    next: 'slot1_chen_bo_A2',
  },
  slot1_chen_bo_A2: {
    id: 'slot1_chen_bo_A2',
    character: 'chen_bo',
    ...
    emotion: 'normal',
    speaker: null,
    textZh: '他数了零钱放在台子上，低头提起布袋。走到门口，回头看了一眼货架，像是在记什么东西。',
    textEn: 'He counts out his change, sets it on the counter, picks up his bag. At the door he turns back, glancing at the shelves — as if memorizing them.',
    next: 'slot1_xiao_li_1',
  },
  slot1_chen_bo_B: {
    id: 'slot1_chen_bo_B',
    ...
    emotion: 'normal',
    speaker: null,
    textZh: '你帮他找到那瓶酒。他道了声谢，数零钱放在台子上，慢慢走了。',
    textEn: 'You find the bottle for him. He thanks you, counts out his change, and leaves slowly.',
    next: 'slot1_xiao_li_1',
  },
  slot1_chen_bo_C: {
    id: 'slot1_chen_bo_C',
    ...
    emotion: 'surprised',
    speaker: null,
    textZh: '你催他快点——老人手一抖，架子上的酒瓶碰倒了，哗啦一声碎在地上。',
    textEn: 'You rush him — the old man\'s hand shakes. A bottle tips from the shelf and shatters on the floor.',
    next: 'slot1_chen_bo_C2',
  },
  slot1_chen_bo_C2: {
    id: 'slot1_chen_bo_C2',
    character: 'chen_bo',
    ...
    emotion: 'surprised',
    speaker: '陈伯',
    textZh: '你——你这孩子！！这是什么态度！！',
    textEn: 'You — what sort of child — what kind of attitude is this!!',
    next: 'fail_jmf_1',
  },
  ...
  slot1_xiao_li_1: {
    ...
    position: 'right',
    emotion: 'normal',
    condition: 'cust_xiao_li',
    speaker: null,
    textZh: '一个穿着反光背心的男人快步进来，头盔还没摘，靴子踏在地上声音很重。',
    textEn: 'A man in a reflective vest strides in, hard hat still on, boots heavy on the floor.',
    next: 'slot1_xiao_li_2',
  },
  slot1_xiao_li_2: {
    id: 'slot1_xiao_li_2',
    character: 'xiao_li',
    ...
    condition: 'cust_xiao_li',
    speaker: '小李',
    textZh: '能量饮料，最强的那种——还有两盒泡面，随便什么口味。',
    textEn: 'Energy drink — strongest you\'ve got. And two packs of instant noodles, any flavor.',
    next: 'slot1_xiao_li_choice',
  },
  slot1_xiao_li_choice: {
    id: 'slot1_xiao_li_choice',
    character: 'xiao_li',
    position: 'right',
    emotion: 'normal',
    condition: 'cust_xiao_li',
  ...
  slot1_xiao_li_A1: {
    ...
    emotion: 'surprised',
    speaker: '小李',
    textZh: '下班？（他愣了一秒。）第三个夜班了。再撑两小时。回去还有赶工期的图纸……不说了，谢了。',
    textEn: 'Off work? (He blinks.) Third night shift in a row. Two more hours. Then blueprints at home… never mind. Thanks.',
    next: 'slot1_xiao_li_end',
  },
  slot1_xiao_li_end: {
    id: 'slot1_xiao_li_end',
    character: 'xiao_li',
    position: 'right',
    emotion: 'normal',
    speaker: null,
  ...
  slot1_laisa_B: {
    ...
    emotion: 'normal',
    speaker: null,
    textZh: '她自己找了一会儿，拿了一块，扫码付钱走了，耳机线轻轻地晃着。',
    textEn: 'She searches the shelf herself, picks one, pays, and leaves, earphone wire swaying gently.',
    next: 'c_intro',
  },
  ...
  slot2_drunk_1: {
    ...
    position: 'right',
    emotion: 'normal',
    condition: 'cust_drunk',
    speaker: null,
    textZh: '一个男的晃进来，身上有浓重的酒气，脚步不太稳。',
    textEn: 'A man stumbles in, reeking of alcohol, steps unsteady.',
    next: 'slot2_drunk_2',
  },
  slot2_drunk_2: {
    id: 'slot2_drunk_2',
    ...
    condition: 'cust_drunk',
    speaker: '酒鬼',
    textZh: '还有……两罐啤的。不对，三罐。对，三罐。（他自己笑了。）',
    textEn: 'Give me… two beers. No, three. Yeah, three. (He laughs at himself.)',
    next: 'slot2_drunk_choice',
  },
  slot2_drunk_choice: {
    id: 'slot2_drunk_choice',
    character: 'drunk',
    position: 'right',
    emotion: 'normal',
    condition: 'cust_drunk',
    ...
    textZh: '',
    textEn: '',
    next: 'slot2_cry_guy_1',
    choices: [
      { labelZh: '"你好像喝得够多了"', labelEn: '"Think you\'ve had enough"', next: 'slot2_drunk_A1', flag: 'helped_drunk' },
      { labelZh: '照给了他', labelEn: 'Give him what he asked for', next: 'slot2_drunk_B' },
      { labelZh: '（叫他出去）', labelEn: '(Tell him to leave)', next: 'slot2_drunk_C' },
    ],
  },
  slot2_drunk_A1: {
    id: 'slot2_drunk_A1',
    ...
    emotion: 'surprised',
    speaker: '酒鬼',
    textZh: '……哈。（他愣了一秒。）你是第一个这么跟我说的。（他把钱放下来，只拿了一罐。）一罐够了，一罐够了。',
    textEn: '…Ha. (He blinks.) You\'re the first one to say that to me. (He puts down the money, takes just one can.) One\'s enough. One\'s enough.',
    next: 'slot2_drunk_end',
  },
  slot2_drunk_end: {
    id: 'slot2_drunk_end',
    character: 'drunk',
    ...
    emotion: 'normal',
    speaker: null,
    textZh: '他晃着出去了，在玻璃门那边停了一下，扶了扶门框，走进雨里。',
    textEn: 'He staggers out, pauses at the door to steady himself, then walks into the rain.',
    next: 'slot2_cry_guy_1',
  },
  slot2_drunk_B: {
    id: 'slot2_drunk_B',
    ...
    emotion: 'happy',
    speaker: null,
    textZh: '你给了他三罐。他乐呵呵地付了钱，踩着不太稳的步子走了。',
    textEn: 'You give him three. He pays cheerfully and ambles off, steps still unsteady.',
    next: 'slot2_cry_guy_1',
  },
  slot2_drunk_C: {
    id: 'slot2_drunk_C',
    ...
    emotion: 'surprised',
    speaker: null,
    textZh: '你让他出去。他站起来，扶着货架，把一整排罐头扫落了一地。',
    textEn: 'You tell him to leave. He stands, grabs the shelf for balance — knocks a whole row of cans onto the floor.',
    next: 'slot2_drunk_C2',
  },
  slot2_drunk_C2: {
    id: 'slot2_drunk_C2',
    ...
    emotion: 'surprised',
    speaker: '酒鬼',
    textZh: '你个小鬼头！！信不信我投诉你！老子还没付钱呢！！',
    textEn: 'You little brat!! I\'ll report you to your boss! I haven\'t even paid yet!!',
    next: 'fail_jmf_1',
  },
  ...
  slot2_cry_guy_1: {
    ...
    position: 'right',
    emotion: 'normal',
    condition: 'cust_cry_guy',
    speaker: null,
    textZh: '一个年轻男的走进来，眼睛通红，抱着一桶冰淇淋，神情有点茫然。',
    textEn: 'A young guy walks in, eyes red-rimmed, clutching a tub of ice cream, looking dazed.',
    next: 'slot2_cry_guy_2',
  },
  slot2_cry_guy_2: {
    id: 'slot2_cry_guy_2',
    character: 'cry_guy',
    ...
    condition: 'cust_cry_guy',
    speaker: '哭包',
    textZh: '就……就这桶。谢了。（他声音沙了，没说完就没说下去了。）',
    textEn: 'Just… just this. Thanks. (His voice cracks and he trails off.)',
    next: 'slot2_cry_guy_choice',
  },
  slot2_cry_guy_choice: {
    id: 'slot2_cry_guy_choice',
    character: 'cry_guy',
    position: 'right',
    emotion: 'normal',
    condition: 'cust_cry_guy',
    ...
    next: 'slot2_isabel_1',
    choices: [
      { labelZh: '从台下拿了包纸巾放在他旁边', labelEn: 'Slide a pack of tissues over', next: 'slot2_cry_guy_A1', flag: 'helped_cry_guy' },
      { labelZh: '默默算了钱，假装没看见', labelEn: 'Ring him up quietly, look away', next: 'slot2_cry_guy_B' },
    ],
  },
  slot2_cry_guy_A1: {
    id: 'slot2_cry_guy_A1',
    ...
    emotion: 'surprised',
    speaker: '哭包',
    textZh: '……（他看了看纸巾，又看了看你。眼泪又下来了。）不行了，我……我就说今天不对劲。',
    textEn: '…(He looks at the tissues, then at you. Tears start again.) I can\'t… I knew today was wrong.',
    next: 'slot2_cry_guy_A2',
  },
  slot2_cry_guy_A2: {
    id: 'slot2_cry_guy_A2',
    character: 'cry_guy',
    ...
    emotion: 'normal',
    speaker: null,
    textZh: '他抽了几张纸巾，哭了一会儿，然后很努力地擦了擦眼睛。临走的时候问了你叫什么名字，重复了一遍，点点头，走了。',
    textEn: 'He takes some tissues and cries a while. Then wipes his eyes hard. On the way out he asks your name, repeats it, nods, and goes.',
    next: 'slot2_isabel_1',
  },
  slot2_cry_guy_B: {
    id: 'slot2_cry_guy_B',
    ...
    emotion: 'normal',
    speaker: null,
    textZh: '你默默扫了码，他付完钱就走了，在门口停了一下，深吸了口气，走进夜里。',
    textEn: 'You ring him up quietly. He pays and goes, pausing in the doorway to take a long breath, then walks into the night.',
    next: 'slot2_isabel_1',
  },
  ...
  slot2_isabel_1: {
    ...
    position: 'right',
    emotion: 'normal',
    condition: 'cust_isabel',
    speaker: null,
    textZh: '玻璃门推开，进来的是一个女孩，没有犹豫，直接走向货架，像来过很多次一样。',
    textEn: 'The door opens. A girl comes in — no hesitation, heading straight for the shelves, like she\'s been here a hundred times.',
    next: 'slot2_isabel_2',
  },
  slot2_isabel_2: {
    id: 'slot2_isabel_2',
    ...
    condition: 'cust_isabel',
    speaker: 'Isabel',
    textZh: '还是那瓶水。（她已经拿在手里了。）',
    textEn: 'The usual. (It\'s already in her hand.)',
    next: 'slot2_isabel_choice',
  },
  slot2_isabel_choice: {
    id: 'slot2_isabel_choice',
    character: 'isabel',
    position: 'right',
    emotion: 'normal',
    condition: 'cust_isabel',
    ...
    next: 'h_intro',
    choices: [
      { labelZh: '"常来的？"', labelEn: '"Regular?"', next: 'slot2_isabel_A1', flag: 'bonded_with_isabel' },
      { labelZh: '扫码，收钱，正常的', labelEn: 'Scan, change, done', next: 'slot2_isabel_B' },
    ],
  },
  slot2_isabel_A1: {
    id: 'slot2_isabel_A1',
    ...
    emotion: 'curious',
    speaker: 'Isabel',
    textZh: '（她想了一下。）算是吧。这条街的东西，我都知道在哪儿。（她看了看你。）就是不太认识收银台后面的人。',
    textEn: '(She thinks.) I suppose. I know where everything is on this street. (She glances at you.) Just not who\'s behind the counter.',
    next: 'slot2_isabel_A2',
  },
  slot2_isabel_A2: {
    id: 'slot2_isabel_A2',
    character: 'isabel',
    ...
    emotion: 'normal',
    speaker: null,
    textZh: '她付完钱走了。出门之前停了一秒，没有回头。',
    textEn: 'She pays and leaves. Pauses a second at the door. Doesn\'t look back.',
    next: 'h_intro',
  },
  slot2_isabel_B: {
    id: 'slot2_isabel_B',
    ...
    emotion: 'normal',
    speaker: null,
    textZh: '她扫了码，你找了零，她说了声谢，转身走了。',
    textEn: 'She scans the code, you make change, she says thanks, and goes.',
    next: 'h_intro',
  },
  ...
  slot3_mei_popo_1: {
    ...
    position: 'right',
    emotion: 'normal',
    condition: 'cust_mei_popo',
    speaker: null,
    textZh: '快到凌晨三点了。玻璃门被推开，进来一个穿睡衣的老太太，笑眯眯的，手里提着个小篮子。',
    textEn: 'Almost three. The door opens. An old woman in pajamas comes in, smiling, carrying a little basket.',
    next: 'slot3_mei_popo_2',
  },
  slot3_mei_popo_2: {
    id: 'slot3_mei_popo_2',
    character: 'mei_popo',
    ...
    condition: 'cust_mei_popo',
    speaker: '梅婆婆',
    textZh: '哎，还没睡啊？我也睡不着嘛，过来买点饼干。',
    textEn: 'Still up? Me too. Couldn\'t sleep. Just came for some biscuits.',
    next: 'slot3_mei_popo_choice',
  },
  slot3_mei_popo_choice: {
    id: 'slot3_mei_popo_choice',
    character: 'mei_popo',
    position: 'right',
    emotion: 'normal',
    condition: 'cust_mei_popo',
    ...
    next: 'slot3_robber_1',
    choices: [
      { labelZh: '和她多聊几句', labelEn: 'Chat with her a bit', next: 'slot3_mei_popo_A1', flag: 'helped_mei_popo' },
      { labelZh: '帮她找好饼干', labelEn: 'Find the biscuits for her', next: 'slot3_mei_popo_B' },
      { labelZh: '（随口应付了几句）', labelEn: '(Brush her off)', next: 'slot3_mei_popo_C' },
    ],
  },
  slot3_mei_popo_A1: {
    id: 'slot3_mei_popo_A1',
    character: 'mei_popo',
    position: 'right',
    emotion: 'happy',
    speaker: '梅婆婆',
    textZh: '我就喜欢这家店，什么时候来都有灯亮着。（她选了两包饼干放进篮子。）我老伴走了以后就这样，睡不着就出来走走，你们这里最近了。',
    textEn: 'I love this shop — lights always on no matter when. (She picks two packs of biscuits.) Since my husband passed, I can\'t sleep. I come out for a walk. This place is closest.',
    next: 'slot3_mei_popo_A2',
  },
  slot3_mei_popo_A2: {
    id: 'slot3_mei_popo_A2',
    character: 'mei_popo',
    position: 'right',
    emotion: 'sad',
    speaker: '梅婆婆',
    textZh: '说是要拆……（她停了一下，没说下去。）唉。走了，不打扰你了。',
    textEn: 'They say they\'ll tear it down… (She trails off.) Well. I\'ll leave you to it.',
    next: 'gh_intro',
  },
  slot3_mei_popo_B: {
    id: 'slot3_mei_popo_B',
    ...
    emotion: 'happy',
    speaker: null,
    textZh: '你帮她找好了饼干，她道了谢，把篮子挎在手弯里，慢慢晃着出去了。',
    textEn: 'You find the biscuits. She thanks you, hooks the basket on her arm, and shuffles out.',
    next: 'gh_intro',
  },
  slot3_mei_popo_C: {
    id: 'slot3_mei_popo_C',
    ...
    emotion: 'curious',
    speaker: null,
    textZh: '你随口应付了几句，没怎么搭理她。老太太歪着头，细细地打量了你一眼。',
    textEn: 'You brush her off with a few absent words. The old woman tilts her head and studies you carefully.',
    next: 'slot3_mei_popo_C2',
  },
  slot3_mei_popo_C2: {
    id: 'slot3_mei_popo_C2',
    character: 'mei_popo',
    position: 'right',
    emotion: 'curious',
    speaker: '梅婆婆',
    textZh: '……你，几岁啊？（她压低声音，说得很认真。）这么晚上班，家里人知道吗？',
    textEn: '…How old are you? (She lowers her voice, quite serious.) Working this late — does your family know?',
    next: 'fail_jmf_1',
  },
  ...
  slot3_robber_1: {
    ...
    position: 'right',
    emotion: 'normal',
    condition: 'cust_robber',
    speaker: null,
    textZh: '凌晨两点五十。一个戴口罩的人推开门，帽子压得很低。他手插在口袋里，没有立刻开口。',
    textEn: 'Two fifty. A masked figure pushes the door open, hood pulled low. Hands in pockets. Doesn\'t speak.',
    next: 'slot3_robber_2',
  },
  slot3_robber_2: {
    id: 'slot3_robber_2',
    ...
    speaker: '？？？',
    textZh: '收银台的钱。都拿出来。',
    textEn: 'The money in the register. All of it.',
    next: 'slot3_robber_choice',
  },
  slot3_robber_choice: {
    id: 'slot3_robber_choice',
    character: 'robber',
    position: 'right',
    emotion: 'normal',
    condition: 'cust_robber',
    ...
    next: 'gh_intro',
    choices: [
      { labelZh: '……好。（慢慢打开收银台）', labelEn: '…Okay. (Open the register)', next: 'slot3_robber_comply', flag: 'robber_complied' },
      { labelZh: '（拿起台子下面的手机）', labelEn: '(Reach for the phone)', next: 'slot3_robber_resist', flag: 'stood_up_to_robber' },
    ],
  },
  slot3_robber_comply: {
    id: 'slot3_robber_comply',
    character: 'robber',
    position: 'right',
    emotion: 'normal',
    speaker: null,
    textZh: '你把钱推过去，他拿走了，转身就走，连话都没说。玻璃门关上的那一刻，你听见自己的心跳。然后一切恢复安静。',
    textEn: 'You push the money over. He takes it and goes without another word. The glass door closes. You hear your own heartbeat. Then silence returns.',
    next: 'gh_intro',
  },
  slot3_robber_resist: {
    id: 'slot3_robber_resist',
    character: 'robber',
    position: 'right',
    emotion: 'surprised',
    speaker: null,
    textZh: '他没退。你的手还没碰到手机，他就扑过来了。',
    textEn: 'He doesn\'t retreat. Before your hand reaches the phone, he lunges.',
    next: 'fail_robber_1',
  },

  // ═══════════════════════════════════════════════════════════
  //  失败路径
  //  fail_jmf_*   : 顾客投诉 → JM·F 发现主角是未成年人
  //  fail_robber_* : 劫匪袭击 → 受伤 → 身份暴露
  // ═══════════════════════════════════════════════════════════
  ...
  fail_jmf_1: {
    ...
    speaker: null,
    textZh: '里间的灯亮了。',
    textEn: 'The back room light comes on.',
    next: 'fail_jmf_2',
  },
  fail_jmf_2: {
    id: 'fail_jmf_2',
    ...
    emotion: 'normal',
    speaker: null,
    textZh: '方明方推门出来，先看了看顾客，再看了看你，没有说话，把场面安抚下去了。等人走了，他轻轻关上玻璃门。',
    textEn: 'JM·F steps out, looks at the customer, then at you — says nothing. He smooths things over. Once the customer leaves, he closes the door quietly.',
    next: 'fail_jmf_3',
  },
  fail_jmf_3: {
    id: 'fail_jmf_3',
    ...
    emotion: 'normal',
    speaker: 'JM·F',
    textZh: '……入职的时候，我让你填了一张表。',
    textEn: '…When you started, I asked you to fill out a form.',
    next: 'fail_jmf_4',
  },
  fail_jmf_4: {
    id: 'fail_jmf_4',
    ...
    speaker: 'JM·F',
    textZh: '你那份，一直是空的。',
    textEn: 'Yours has always been blank.',
    next: 'fail_jmf_5',
  },
  fail_jmf_5: {
    id: 'fail_jmf_5',
  ...
  fail_jmf_6: {
    ...
    emotion: 'sad',
    speaker: null,
    textZh: '你没说。他叹了口气，走回里间，轻轻带上了门。你听见他在打电话——声音很低，听不清说什么。',
    textEn: 'You say nothing. He sighs, steps back into the stockroom, and closes the door gently. You hear him on the phone — too quiet to make out.',
    next: 'fail_jmf_end',
  },
  fail_jmf_end: {
    id: 'fail_jmf_end',
    ...
    failed: true,
    speaker: null,
    textZh: '你坐在里间的折叠椅上，手里捧着一杯他泡好的热茶，还烫着。窗外天还是黑的。你想起离开家的那天，也是个这样的雨夜。',
    textEn: 'You sit in the stockroom on a folding chair, holding a cup of tea he made for you — still hot. Outside, still dark. You think of the night you left home. It was raining like this.',
  },
  ...
  fail_robber_1: {
    ...
    emotion: 'normal',
    speaker: null,
    textZh: '你不记得具体发生了什么。只记得后背撞上了货架，有什么东西砸下来，然后是玻璃碎裂的声音。',
    textEn: 'You don\'t remember the details — just your back hitting the shelf, something falling, then the sound of breaking glass.',
    next: 'fail_robber_2',
  },
  fail_robber_2: {
    id: 'fail_robber_2',
  ...
  fail_robber_3: {
    ...
    emotion: 'surprised',
    speaker: null,
    textZh: '方明方冲出来——劫匪跑了。他蹲下来，看了看你，手抖了一下。',
    textEn: 'JM·F rushes out — the robber flees. He crouches beside you, hands slightly shaking.',
    next: 'fail_robber_4',
  },
  fail_robber_4: {
    id: 'fail_robber_4',
  ...
  fail_robber_5: {
    ...
    emotion: 'sad',
    speaker: null,
    textZh: '他扶你进里间，倒了水，帮你检查了伤口，没有多问。等了一会儿，才开口。',
    textEn: 'He helps you to the stockroom, gets water, checks your injuries — asks nothing. After a while:',
    next: 'fail_robber_6',
  },
  fail_robber_6: {
    id: 'fail_robber_6',
    ...
    speaker: 'JM·F',
    textZh: '……你家里人，知道你在这里吗。',
    textEn: '…Does anyone at home know you\'re here.',
    next: 'fail_robber_end',
  },
  fail_robber_end: {
    id: 'fail_robber_end',
    scene: 'backroom',
    failed: true,
    speaker: null,
    textZh: '你靠着里间的箱子坐着，等着。他在外面守着——等天亮，也等另一个人来。窗外，已经有鸟叫了。',
    textEn: 'You lean against the storeroom boxes, waiting. He keeps watch outside — waiting for dawn, and for someone else to arrive. Outside, a bird has started to sing.',
  },
  ...
  ending_ghost: {
    ...
    pages: [
      { textZh: '玻璃门无风自动，他走向门外，消失在光里。便利店的灯突然全部变暖。', textEn: 'The glass door opens by itself. He walks out into the light and disappears. All the store\'s lights turn warm at once.' },
