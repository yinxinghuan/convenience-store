 ...
 * 深夜便利店 — 故事结构
 * ─────────────────────
 * 凌晨12点 → 阿晨（外卖骑手，苏理的前男友）
 * 凌晨1点  → 苏理（城市史研究生，方明的女儿）
 * 凌晨2点  → 方明（便利店老板，苏理的父亲，阿晨的匿名恩人）
 * 凌晨3点  → 幽灵（1984年的见证者）
 * 黎明     → 八个结局
 *
 * FLAGS:
 *  g_shared            — 阿晨说出了自己在这条街的原因
 *  aichen_honest       — 阿晨提到了苏理
 *  g_warm              — 你鼓励了阿晨
 *  c_connected         — 苏理感到被理解
 *  c_stayed            — 苏理凌晨2点还在（留下来了）
 *  suli_forgave        — 苏理对阿晨放下了什么
 *  suli_recorded       — 苏理录下了方明的口述
 *  suli_confronted_dad — 苏理直接质问了方明关于1998年
 *  fangming_explained  — 方明解释了1998年的事
 *  fangming_benefactor — 发现方明是阿晨的匿名资助人
 *  fangming_letter     — 苏理找到了方明从未寄出的信
...
export const STORY: Record<string, StoryBeat> = {
  ...
  c_backroom: {
    ...
    scene: 'backroom',
    speaker: null,
    textZh: '后室的门是虚掩着的。你们进去，里面堆满了纸箱，角落里有个旧铁皮文件柜，生了锈。苏理打开手机灯。',
    textEn: 'The back room door is ajar. Inside: stacked boxes, an old metal filing cabinet rusted in the corner. Suli turns on her phone light.',
    next: 'c_backroom2',
    flag: 'c_connected',
  },
  c_backroom2: {
  ...
  c_letters: {
    ...
    emotion: 'normal',
    speaker: null,
    textZh: '她继续往下翻，第二抽屉里是一摞信件，用橡皮筋捆着。收件人：苏理，转交苏理妈妈。寄件人：方明。',
    textEn: 'She continues. Second drawer: a bundle of letters, rubber-banded together. Addressee: Suli, care of Suli\'s mother. Sender: Fang Ming.',
    next: 'c_letters2',
  },
  c_letters2: {
    id: 'c_letters2',
    ...
    emotion: 'surprised',
    speaker: null,
    textZh: '苏理的手停住了。橡皮筋很旧，一碰就断了。最早的一封，邮戳是1999年。最晚的，2006年。没有一封寄出去过。',
    textEn: 'Suli\'s hands go still. The rubber band is old, snaps when she touches it. The earliest letter: 1999. The latest: 2006. Not one was sent.',
    next: 'c_letters3',
  ...
  h_enter: {
    ...
    emotion: 'normal',
    speaker: null,
    textZh: '方明从后室走出来，手里拿着一个账本，眼镜推在额头上，看见你点了点头，然后扫了一眼店里——',
    textEn: 'Fang Ming comes out of the back room with a ledger, glasses pushed up on his forehead. He nods at you, then scans the store —',
    next: 'h_suli_meet',
  },
  // CONDITIONAL — 苏理还在
  h_suli_meet: {
    ...
    condition: 'c_stayed',
    speaker: null,
    textZh: '他和窗边的苏理对上了眼。两个人都没有说话，像两扇窗突然被风推开，又被什么重新关上。',
    textEn: 'His eyes meet Suli\'s across the store. Neither speaks — like two windows blown open by wind, then quietly shut again.',
    next: 'h_suli_choice',
  },
  h_suli_choice: {
    id: 'h_suli_choice',
  ...
  h_choice1: {
    ...
    emotion: 'normal',
    speaker: null,
    textZh: '你想到了很多。方明在这里开了二十年店，这里之前是糖果铺，后室里有信有钥匙，还有今晚来过的那个骑手……',
    textEn: 'You think about everything. Fang Ming has run this store for twenty years. The candy shop before it. Letters and a key in the back. And the rider who came earlier...',
    choices: [
  ...
  h_benefactor_reveal3: {
    ...
    emotion: 'sad',
    speaker: null,
    textZh: '方明看了一会儿那张传单。他把眼镜摘下来，慢慢擦了擦。',
    textEn: 'Fang Ming looks at the flyer for a long time. He takes off his glasses and slowly wipes them.',
    next: 'h_exit',
  },
  ...
  h_record: {
    ...
    condition: 'c_stayed',
    speaker: null,
    textZh: '苏理从包里拿出录音笔，放在柜台上，看着方明。"如果你愿意，我可以录下来。关于这条街的事。"',
    textEn: 'Suli takes out a voice recorder, sets it on the counter, and looks at Fang Ming. "If you\'re willing, I can record it. About this street."',
    next: 'h_record2',
  },
  h_record2: {
    id: 'h_record2',
  ...
  ending_archive: {
    id: 'ending_archive',
    speaker: null,
    textZh: '三个月后，37号便利店被拆了。但在拆之前，苏理用城市档案馆32号室的钥匙打开了一扇门。',
    textEn: 'Three months later, Store No. 37 came down. But before it did, Suli used the archive key to open Room 32.',
    pages: [
  ...
  ending_debt: {
    id: 'ending_debt',
    speaker: null,
    textZh: '方明从后室拿出一个旧账本，翻到某一页，推给阿晨。',
    textEn: 'Fang Ming brings an old ledger from the back, opens to a page, slides it to Aichen.',
    pages: [
      ...
      { textZh: '阿晨盯着账本很久，说："是你。"\n\n方明说："账清了。"\n\n阿晨没有说谢谢，但他留下来，帮方明关了店。', textEn: 'Aichen stares for a long time. "It was you."\n\nFang Ming says: "We\'re even."\n\nAichen doesn\'t say thank you. But he stays, and helps Fang Ming close up.' },
    ],
  },
  ...
  ending_37: {
    ...
    pages: [
      { textZh: '苏理联系到了三十几个曾经住在这条街上的人。开发商推迟了决定，等待历史建筑评估结果。', textEn: 'Suli contacted thirty-some former residents. The developer delayed, pending a heritage assessment.' },
      { textZh: '方明站在门里，看着外面的人群，眼睛红了。他打开了新一天的账本，在第一行写下：今日营业正常。', textEn: 'Fang Ming stood inside, watching the crowd. His eyes were red. He opened a new ledger and wrote on the first line: Business as usual today.' },
    ],
  },
  ...
  ending_reunion: {
    id: 'ending_reunion',
    speaker: null,
    textZh: '天亮之前，苏理把那封信还给方明，转身在门口看见了阿晨——他又回来了。',
    textEn: 'Before dawn, Suli returns the letter to Fang Ming and turns — Aichen is at the door. He came back.',
    pages: [
  ...
  ending_family: {
    id: 'ending_family',
    speaker: null,
    textZh: '苏理把那摞信放在收银台上，一封一封地排开。方明站在对面，手在抖。',
    textEn: 'Suli lays the bundle of letters on the counter, spreading them one by one. Fang Ming stands across from her, hands trembling.',
    pages: [
      { textZh: '"你从来没寄过。"\n"我不知道怎么说对不起。"', textEn: '"You never sent them."\n"I didn\'t know how to say sorry."' },
      { textZh: '苏理哭了，不是因为原谅了他，而是因为她终于知道他也在痛。', textEn: 'Suli cries — not because she\'s forgiven him, but because she finally knows he was hurting too.' },
  ...
  ending_ghost: {
    id: 'ending_ghost',
    speaker: null,
    textZh: '凌晨三点整，幽灵第一次用正常的声音说话，不再飘忽。\n\n"我在等一件事结束。今晚，结束了。"',
  ...
  ending_3am: {
    ...
    pages: [
      { textZh: '阿晨推门进来，这次不是送外卖，只是来坐一会儿。苏理在角落里写东西。方明在擦货架。没有人觉得这很奇怪。', textEn: 'Aichen pushes in — not delivering, just to sit a while. Suli is writing in the corner. Fang Ming wipes shelves. Nobody finds this strange.' },
      ...
      { textZh: '结账音效响起。方明抬头说："今晚有点忙。"\n\n没有人问他为什么笑。\n\n画面定格。', textEn: 'The register chimes. Fang Ming looks up. "Busy tonight."\n\nNobody asks why he\'s smiling.\n\nFade to still.' },
    ],
  },
};
