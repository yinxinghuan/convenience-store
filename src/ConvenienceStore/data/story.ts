...
export const STORY: Record<string, StoryBeat> = {
  ...
  slot3_robber_resist: {
    ...
    speaker: '？？？',
    textZh: '……（他愣了一下。退了一步。）你……',
    textEn: '…(He hesitates. Steps back.) You—',
    next: 'slot3_robber_resist2',
  },
  slot3_robber_resist2: {
    id: 'slot3_robber_resist2',
    character: 'robber',
    position: 'right',
    emotion: 'normal',
    speaker: null,
    textZh: '他没说完。他看了看那扇玻璃门，又看了看你，最后还是走了，脚步比进来的时候快了很多。',
    textEn: 'He doesn\'t finish. He looks at the door, then at you. Then he leaves — much faster than he came in.',
    next: 'gh_intro',
  },
